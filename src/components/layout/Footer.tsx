      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12 mb-12">
        <div className="col-span-1">
          ...
          <div className="bg-primary-foreground/90 p-3 rounded-2xl w-fit mb-6 flex gap-2">
            <Image src="/images/SatrLogo.png" alt="شعار متجر سطر الرسمي - الوضع الفاتح" width={90} height={30} style={{ width: "auto", height: "auto" }} className="object-contain dark:hidden block" />
            <Image src="/images/whitelogo.png" alt="شعار متجر سطر الرسمي - الوضع الداكن" width={90} height={30} style={{ width: "auto", height: "auto" }} className="object-contain hidden dark:block" />
          </div>
