      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 sm:gap-12 mb-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-primary-foreground/10 text-primary-foreground rounded-full hover:bg-secondary transition-colors shadow-sm"><IconTwitter /></a>
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-primary-foreground/10 text-primary-foreground rounded-full hover:bg-secondary transition-colors shadow-sm"><IconGithub /></a>
          </div>
        </div>
