    ...
    <div className="min-h-screen bg-background selection:bg-secondary selection:text-white pb-20 relative">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-36 lg:pt-48 pb-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground mb-6">سياسة الخصوصية</h1>
          <p className="text-lg text-muted-foreground font-medium">نحن نقدر بياناتك ونحميها.</p>
        </motion.div>
